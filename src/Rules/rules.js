    ...
    return (
      <div className="rules">
        ...
        <div className="explanation">
          ...
          <p>You'll see a nuclear family that no one really has on the next page. But don't worry, you can edit or delete each of these members. If you're left with no one on the board, you'll can still add in new members. So throw in your neighbor, your best friend, Jake from State Farm, or anyone else who wants in.</p><br />
